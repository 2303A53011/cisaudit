...
register_control \
  --id "1.1.1.1" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.1.1.2" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.1.1.3" --section "1_initial_setup" --level "2" --scored "yes" \
...
register_control \
  --id "1.1.2.1" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.1.2.2" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.1.2.3" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.1.2.4" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.1.3.2" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.1.3.3" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.2.1" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.2.2" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.3.1" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.3.2" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.4.1" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.5.1" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.5.2" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.5.3" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.5.4" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.6.1" --section "1_initial_setup" --level "1" --scored "yes" \
...
register_control \
  --id "1.6.2" --section "1_initial_setup" --level "1" --scored "yes" \
